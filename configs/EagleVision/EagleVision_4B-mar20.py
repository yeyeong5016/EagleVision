...
angle_version = 'le90'
pretrained = "/mnt/data1/jianghx/ckpts/InternVL2-4B"
num_image_token = 64
template = "phi3-chat"
backend_args = None
...
optim_wrapper = dict(
    ...
    optimizer=dict(type='DeepSpeedCPUAdam', lr=6e-4))
...
test_evaluator_task1 = dict(
    ...
    format_only=False,
    merge_patches=False,
    img_path='/mnt/data1/jianghx/data/MAR20/test/images',
    task='Task1',
    outfile_prefix='./work_dirs/EagleVision_2B-mar20/val')

test_evaluator_task2 = dict(
    type='EVBench',
    format_only=True,
    merge_patches=False,
	xml_path='/mnt/data1/jianghx/data/MAR20/test/labelXml',
    caption_gt_path='/mnt/data1/jianghx/data/MAR20/EVAttrs-MAR20-test.json',
    task='Task2',
    outfile_prefix='./work_dirs/EagleVision_2B-mar20/val')
